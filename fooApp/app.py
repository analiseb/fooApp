...
#Before -request and after-request callbacks (not sure if these are meant to be included)
@app.before_request
...
# Handling Static files, path to HIPPO jpg !!

import flask
flask.url_for('static', filename='hippo.jpg')

'C:\Users\anali\ADS\W4\fooApp\static'

#Putting all together: Displaying a record
